...
function ShowNoPhoneWarning () 
  ...
  exports['mythic_notify']:DoCustomHudText('error', 'Telefonunuz Yok!', 3000)
end
...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    ...
    if ShowNumberNotification == true then
      exports['mythic_notify']:DoHudText('inform', 'Mesaj Geldi. &nbsp;'.. message.transmitter, 5000)
      for _,contact in pairs(contacts) do
        if contact.number == message.transmitter then
          exports['mythic_notify']:DoHudText('inform', 'Kişi: &nbsp;'.. contact.display, 5000)
          break
        end
      end
    end
